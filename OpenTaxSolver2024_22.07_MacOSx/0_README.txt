...
-----------------------------------------------------------
  (Compiled on OS X Yosemite 10.10.)
  ( Should run on same or newer versions of OSx. )

NOTE: For Mac's running Catalina (MacOS-10.15) and above, such as Big Sur (MacOS-11),
	and Monterey (MacOS-12))  --- These newer Mac-OS versions have additional
